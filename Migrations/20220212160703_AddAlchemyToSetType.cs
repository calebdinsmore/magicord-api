...
{
    public partial class AddAlchemyToSetType : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("ALTER TYPE dbo.sets_type ADD VALUE 'alchemy';", suppressTransaction: true);
            ...
            //     .Annotation("Npgsql:Enum:dbo.legalities_format", "alchemy,commander,duel,legacy,modern,vintage,pauper,penny,historic,pioneer,brawl,future,standard,oldschool")
            ...
            //     .Annotation("Npgsql:Enum:dbo.sets_type", "alchemy,core,masters,expansion,starter,memorabilia,archenemy,box,draft_innovation,commander,funny,duel_deck,from_the_vault,masterpiece,promo,premium_deck,planechase,token,vanguard,treasure_chest,spellbook")
        ...
        {
            migrationBuilder.Sql("ALTER TYPE dbo.sets_type REMOVE VALUE 'alchemy';", suppressTransaction: true);
            // migrationBuilder.AlterDatabase()
            //     .Annotation("Npgsql:Enum:dbo.cards_border_color", "black,white,borderless,silver,gold")
            //     .Annotation("Npgsql:Enum:dbo.cards_frame_version", "2003,1993,2015,1997,future")
            //     .Annotation("Npgsql:Enum:dbo.cards_layout", "normal,aftermath,split,flip,leveler,saga,vanguard,transform,adventure,meld,scheme,planar,host,augment")
            ...
            //     .OldAnnotation("Npgsql:Enum:dbo.cards_rarity", "rare,uncommon,common,mythic,special,bonus")
            //     .OldAnnotation("Npgsql:Enum:dbo.foreign_data_language", "German,Spanish,French,Italian,Japanese,Portuguese (Brazil),Russian,Chinese Simplified,Korean,Chinese Traditional,Phyrexian,Sanskrit,Hebrew,Ancient Greek,Latin,Arabic")
            //     .OldAnnotation("Npgsql:Enum:dbo.legalities_format", "alchemy,commander,duel,legacy,modern,vintage,pauper,penny,historic,pioneer,brawl,future,standard,oldschool")
            //     .OldAnnotation("Npgsql:Enum:dbo.legalities_status", "Legal,Banned,Restricted")
            //     .OldAnnotation("Npgsql:Enum:dbo.set_translations_language", "Chinese Simplified,Chinese Traditional,French,German,Italian,Japanese,Korean,Portuguese (Brazil),Russian,Spanish")
            //     .OldAnnotation("Npgsql:Enum:dbo.sets_type", "alchemy,core,masters,expansion,starter,memorabilia,archenemy,box,draft_innovation,commander,funny,duel_deck,from_the_vault,masterpiece,promo,premium_deck,planechase,token,vanguard,treasure_chest,spellbook")
            //     .OldAnnotation("Npgsql:Enum:dbo.tokens_border_color", "black,borderless,silver,gold")
            //     .OldAnnotation("Npgsql:Enum:dbo.tokens_layout", "token,double_faced_token,emblem,art_series,normal");
        }
    }
