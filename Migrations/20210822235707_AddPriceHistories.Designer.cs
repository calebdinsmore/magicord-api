...
namespace Magicord.Migrations
{
    ...
    [Migration("20210822235707_AddPriceHistories")]
    partial class AddPriceHistories
    {
            ...
            modelBuilder.Entity("Magicord.Models.CardPriceHistory", b =>
                {
                    b.HasOne("Magicord.Models.CardPrice", "CardPrice")
                        ...
                        .HasConstraintName("fk_card_price_history_card_prices_card_price_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Magicord.Models.Card", "Card")
                        ...
                        .HasConstraintName("fk_card_price_history_cards_card_id")
