...
namespace Magicord.Migrations
{
    ...
    [Migration("20220212160703_AddAlchemyToSetType")]
    partial class AddAlchemyToSetType
    {
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "dbo", "cards_border_color", new[] { "black", "white", "borderless", "silver", "gold" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "dbo", "cards_frame_version", new[] { "2003", "1993", "2015", "1997", "future" });
            ...
            modelBuilder.Entity("Magicord.Models.CardPriceHistory", b =>
                {
                    ...
                    b.ToTable("card_price_history", "dbo");
                });
            ...
            modelBuilder.Entity("Magicord.Models.SealedEventAttendee", b =>
                {
                    ...
                    b.ToTable("sealed_event_attendee", "dbo");
                });
            ...
            modelBuilder.Entity("Magicord.Models.SealedEventPack", b =>
                {
                    ...
                    b.ToTable("sealed_event_pack", "dbo");
                });

            modelBuilder.Entity("Magicord.Models.SealedEventPromo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_sealed_event_promo");

                    b.HasIndex("SealedEventId")
                        .HasDatabaseName("ix_sealed_event_promo_sealed_event_id");

                    b.ToTable("sealed_event_promo", "dbo");
                });
            ...
            modelBuilder.Entity("Magicord.Models.StoreBoosterListing", b =>
                {
                    ...
                    b.ToTable("store_booster_listing", "dbo");
                });
            ...
            modelBuilder.Entity("Magicord.Models.UserBoosterCard", b =>
                {
                    ...
                    b.ToTable("user_booster_card", "dbo");
                });
            ...
            modelBuilder.Entity("Magicord.Models.SealedEventPromo", b =>
                {
                    b.HasOne("Magicord.Models.SealedEvent", "SealedEvent")
                        .WithMany("SealedEventPromos")
                        .HasForeignKey("SealedEventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_sealed_event_promo_sealed_events_sealed_event_id");
            ...
            modelBuilder.Entity("Magicord.Models.SealedEvent", b =>
                {
                    ...
                    b.Navigation("SealedEventPromos");
                });
