...
namespace Magicord.Migrations
{
    ...
    [Migration("20200909010042_UpdateUserCardToUseUuid")]
    partial class UpdateUserCardToUseUuid
    {
            ...
            modelBuilder.Entity("Magicord.Models.CardPrice", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_card_prices");

                    b.HasIndex("CardUuid")
                        .IsUnique()
                        .HasName("ix_card_price_card_uuid");
            ...
            modelBuilder.Entity("Magicord.Models.CardPrice", b =>
                {
                    b.HasOne("Magicord.Models.Card", "Card")
                        ...
                        .HasConstraintName("fk_card_prices_cards_card_id")
